 ...
 *
 * The blocks pulse. Held still they read as a layout that failed to paint
 * rather than one that is on its way, which is the difference between "loading"
 * and "broken" to anyone who is not waiting on purpose.
 */
